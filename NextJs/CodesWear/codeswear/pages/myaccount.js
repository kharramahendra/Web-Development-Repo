...
const Myaccount = () => {
  ...
  return (
    <div className='container mx-auto min-h-screen'>
      ...
      <button onClick={handleUserSubmit} className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm"> Submit</button>
      ...
      <button onClick={handlePasswordSubmit} className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm"> Submit</button>
