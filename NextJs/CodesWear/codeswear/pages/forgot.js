  ...
  return (
    ...
    <div className="max-w-md w-full space-y-8">
      <div>
        ...
        <div>
          <button disabled={!password==cpassword} onClick={resetPassword} type="submit" className=" disabled:bg-pink-300 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">
