  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <p>
          Your Payment Status is : <span className='font-semibol text-cyan-700'>{order.status}</span>
        </p>
        <div className="flex mb-4">
          <a className="flex-grow text-center text-cyan-500 border-b-2 border-cyan-500 py-2 text-lg px-1">Item Description</a>
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded">Track Ordeer</button>
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch('http://127.0.0.1:8000/order/', {
        method: "POST",
        headers: {
